...
/**
 * ArcglcoId generated by hbm2java
 */
@Embeddable
public class ArcglcoId  implements java.io.Serializable {
    ...
    public ArcglcoId(String noCia, String tipoDoc, String noDocu) {
       this.noCia = noCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArcglcoId) ) return false;
		 ArcglcoId castOther = ( ArcglcoId ) other; 
