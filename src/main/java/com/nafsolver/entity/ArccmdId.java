...
/**
 * ArccmdId generated by hbm2java
 */
@Embeddable
public class ArccmdId  implements java.io.Serializable {
    ...
    public ArccmdId(String noCia, String noDocu) {
       this.noCia = noCia;
       this.noDocu = noDocu;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArccmdId) ) return false;
		 ArccmdId castOther = ( ArccmdId ) other; 
