...
/**
 * ArinmeId generated by hbm2java
 */
@Embeddable
public class ArinmeId  implements java.io.Serializable {
    ...
    public ArinmeId(String noCia, String noDocu) {
       this.noCia = noCia;
       this.noDocu = noDocu;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArinmeId) ) return false;
		 ArinmeId castOther = ( ArinmeId ) other; 
