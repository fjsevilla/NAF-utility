...
/**
 * ArinmlId generated by hbm2java
 */
@Embeddable
public class ArinmlId  implements java.io.Serializable {
    ...
    public ArinmlId(String noCia, String noDocu, short linea) {
       this.noCia = noCia;
       this.noDocu = noDocu;
       this.linea = linea;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArinmlId) ) return false;
		 ArinmlId castOther = ( ArinmlId ) other; 
