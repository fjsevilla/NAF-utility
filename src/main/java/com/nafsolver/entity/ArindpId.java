...
/**
 * ArindpId generated by hbm2java
 */
@Embeddable
public class ArindpId  implements java.io.Serializable {
    ...
    public ArindpId(String noCia, String tipo) {
       this.noCia = noCia;
       this.tipo = tipo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArindpId) ) return false;
		 ArindpId castOther = ( ArindpId ) other; 
