...
/**
 * ArcpmdId generated by hbm2java
 */
@Embeddable
public class ArcpmdId  implements java.io.Serializable {
    ...
    public ArcpmdId(String noCia, String noDocu) {
       this.noCia = noCia;
       this.noDocu = noDocu;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArcpmdId) ) return false;
		 ArcpmdId castOther = ( ArcpmdId ) other; 
