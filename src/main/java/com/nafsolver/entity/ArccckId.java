...
/**
 * ArccckId generated by hbm2java
 */
@Embeddable
public class ArccckId  implements java.io.Serializable {
    ...
    public ArccckId(String noCia, String noDocu) {
       this.noCia = noCia;
       this.noDocu = noDocu;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArccckId) ) return false;
		 ArccckId castOther = ( ArccckId ) other; 
