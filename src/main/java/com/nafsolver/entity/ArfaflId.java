...
/**
 * ArfaflId generated by hbm2java
 */
@Embeddable
public class ArfaflId  implements java.io.Serializable {
    ...
    public ArfaflId(String noCia, String noFactu, int noLinea) {
       this.noCia = noCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArfaflId) ) return false;
		 ArfaflId castOther = ( ArfaflId ) other; 
