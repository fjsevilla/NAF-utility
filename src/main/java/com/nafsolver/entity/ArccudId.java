...
/**
 * ArccudId generated by hbm2java
 */
@Embeddable
public class ArccudId  implements java.io.Serializable {
    ...
    public ArccudId(String noCia, String tipo, String usuario) {
       this.noCia = noCia;
       this.tipo = tipo;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArccudId) ) return false;
		 ArccudId castOther = ( ArccudId ) other; 
