...
/**
 * ArinhaTaId generated by hbm2java
 */
@Embeddable
public class ArinhaTaId  implements java.io.Serializable {
    ...
    public ArinhaTaId(String noCia, String centro, short ano, byte semana, String indSem, String bodega, String clase, String categoria, String noArti, BigDecimal talla) {
       this.noCia = noCia;
       this.centro = centro;
       this.ano = ano;
       this.semana = semana;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArinhaTaId) ) return false;
		 ArinhaTaId castOther = ( ArinhaTaId ) other; 
