...
/**
 * ArcptdId generated by hbm2java
 */
@Embeddable
public class ArcptdId  implements java.io.Serializable {
    ...
    public ArcptdId(String noCia, String tipoDoc) {
       this.noCia = noCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArcptdId) ) return false;
		 ArcptdId castOther = ( ArcptdId ) other; 
