...
/**
 * ArfaflTahId generated by hbm2java
 */
@Embeddable
public class ArfaflTahId  implements java.io.Serializable {
    ...
    public ArfaflTahId(String noCia, String noFactu, int noLinea, BigDecimal talla) {
       this.noCia = noCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArfaflTahId) ) return false;
		 ArfaflTahId castOther = ( ArfaflTahId ) other; 
