...
/**
 * ArfafechId generated by hbm2java
 */
@Embeddable
public class ArfafechId  implements java.io.Serializable {
    ...
    public ArfafechId(String noCia, String noFactu) {
       this.noCia = noCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArfafechId) ) return false;
		 ArfafechId castOther = ( ArfafechId ) other; 
