...
/**
 * ArccmdHId generated by hbm2java
 */
@Embeddable
public class ArccmdHId  implements java.io.Serializable {
    ...
    public ArccmdHId(String noCia, String noDocu) {
       this.noCia = noCia;
       this.noDocu = noDocu;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArccmdHId) ) return false;
		 ArccmdHId castOther = ( ArccmdHId ) other; 
