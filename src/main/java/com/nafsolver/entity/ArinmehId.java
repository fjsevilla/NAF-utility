...
/**
 * ArinmehId generated by hbm2java
 */
@Embeddable
public class ArinmehId  implements java.io.Serializable {
    ...
    public ArinmehId(String noCia, String noDocu) {
       this.noCia = noCia;
       this.noDocu = noDocu;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArinmehId) ) return false;
		 ArinmehId castOther = ( ArinmehId ) other; 
