...
/**
 * ArintpId generated by hbm2java
 */
@Embeddable
public class ArintpId  implements java.io.Serializable {
    ...
    public ArintpId(String noCia, String clase, String categoria, String codigo, String tipo) {
       this.noCia = noCia;
       this.clase = clase;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArintpId) ) return false;
		 ArintpId castOther = ( ArintpId ) other; 
