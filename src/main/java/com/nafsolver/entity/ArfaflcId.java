...
/**
 * ArfaflcId generated by hbm2java
 */
@Embeddable
public class ArfaflcId  implements java.io.Serializable {
    ...
    public ArfaflcId(String noCia, String noFactu, int noLinea) {
       this.noCia = noCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArfaflcId) ) return false;
		 ArfaflcId castOther = ( ArfaflcId ) other; 
