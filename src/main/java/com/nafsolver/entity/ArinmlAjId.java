...
/**
 * ArinmlAjId generated by hbm2java
 */
@Embeddable
public class ArinmlAjId  implements java.io.Serializable {
    ...
    public ArinmlAjId(String noCia, String noDocu, short linea) {
       this.noCia = noCia;
       this.noDocu = noDocu;
       this.linea = linea;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArinmlAjId) ) return false;
		 ArinmlAjId castOther = ( ArinmlAjId ) other; 
