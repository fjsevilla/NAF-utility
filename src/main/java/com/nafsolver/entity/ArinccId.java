...
/**
 * ArinccId generated by hbm2java
 */
@Embeddable
public class ArinccId  implements java.io.Serializable {
    ...
    public ArinccId(String noCia, String grupo, String tipoDoc) {
       this.noCia = noCia;
       this.grupo = grupo;
    ...
    @Column(name="TIPO_DOC", nullable=false, length=15)
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArinccId) ) return false;
		 ArinccId castOther = ( ArinccId ) other; 
