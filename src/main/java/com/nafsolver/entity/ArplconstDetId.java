...
/**
 * ArplconstDetId generated by hbm2java
 */
@Embeddable
public class ArplconstDetId  implements java.io.Serializable {
    ...
    public ArplconstDetId() {
    }

    public ArplconstDetId(String noCia, String noConst, String noEmple) {
       this.noCia = noCia;
    ...
    @Column(name="NO_EMPLE", nullable=false, length=5)
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArplconstDetId) ) return false;
		 ArplconstDetId castOther = ( ArplconstDetId ) other; 
