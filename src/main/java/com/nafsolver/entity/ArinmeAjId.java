...
/**
 * ArinmeAjId generated by hbm2java
 */
@Embeddable
public class ArinmeAjId  implements java.io.Serializable {
    ...
    public ArinmeAjId(String noCia, String noDocu) {
       this.noCia = noCia;
       this.noDocu = noDocu;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArinmeAjId) ) return false;
		 ArinmeAjId castOther = ( ArinmeAjId ) other; 
