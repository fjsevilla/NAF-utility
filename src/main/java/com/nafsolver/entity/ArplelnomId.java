...
/**
 * ArplelnomId generated by hbm2java
 */
@Embeddable
public class ArplelnomId  implements java.io.Serializable {
    ...
    public ArplelnomId(String noCia, String noElnom, String codpla, String tipoEmp, String noEmple) {
       this.noCia = noCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArplelnomId) ) return false;
		 ArplelnomId castOther = ( ArplelnomId ) other; 
