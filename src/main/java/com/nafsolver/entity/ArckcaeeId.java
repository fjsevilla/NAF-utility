...
/**
 * ArckcaeeId generated by hbm2java
 */
@Embeddable
public class ArckcaeeId  implements java.io.Serializable {
    ...
    public ArckcaeeId(String noCia, int noDocu) {
       this.noCia = noCia;
       this.noDocu = noDocu;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArckcaeeId) ) return false;
		 ArckcaeeId castOther = ( ArckcaeeId ) other; 
