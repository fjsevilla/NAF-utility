...
/**
 * Arcgaeh generated by hbm2java
 */
@Entity
@Table(name="ARCGAEH"
    ,schema="DESA46"
)
public class Arcgaeh  implements java.io.Serializable {


     private ArcgaehId id;
     private Short ano;
     private Byte mes;
     ...
     private Date tstamp;
     private BigDecimal TDebitosRes;
     private BigDecimal TCreditosRes;

    public Arcgaeh() {
    }

	
    public Arcgaeh(ArcgaehId id) {
        this.id = id;
    }
    public Arcgaeh(ArcgaehId id, Short ano, Byte mes, String impreso, Date fecha, String descri1, String estado, String autorizado, String origen, BigDecimal TDebitos, BigDecimal TCreditos, String codDiario, String TCambCV, BigDecimal tipoCambio, String tipoComprobante, String noComprobante, String anulado, String centrod, String centrof, String corporativo, Date tstamp, BigDecimal TDebitosRes, BigDecimal TCreditosRes) {
       this.id = id;
       this.ano = ano;
       this.mes = mes;
       ...
       this.tstamp = tstamp;
       this.TDebitosRes = TDebitosRes;
       this.TCreditosRes = TCreditosRes;
    }
    ...
    public ArcgaehId getId() {
        return this.id;
    }
    
    public void setId(ArcgaehId id) {
        this.id = id;
    }
    ...
    public BigDecimal getTDebitosRes() {
        return this.TDebitosRes;
    }
    
    public void setTDebitosRes(BigDecimal TDebitosRes) {
        this.TDebitosRes = TDebitosRes;
    }

    
    @Column(name="T_CREDITOS_RES", precision=30)
    public BigDecimal getTCreditosRes() {
        return this.TCreditosRes;
    }
    
    public void setTCreditosRes(BigDecimal TCreditosRes) {
        this.TCreditosRes = TCreditosRes;
    }
