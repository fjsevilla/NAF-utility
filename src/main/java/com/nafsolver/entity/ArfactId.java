...
/**
 * ArfactId generated by hbm2java
 */
@Embeddable
public class ArfactId  implements java.io.Serializable {
    ...
    public ArfactId(String noCia, String tipo) {
       this.noCia = noCia;
       this.tipo = tipo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArfactId) ) return false;
		 ArfactId castOther = ( ArfactId ) other; 
