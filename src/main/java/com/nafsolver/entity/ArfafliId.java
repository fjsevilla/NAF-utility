...
/**
 * ArfafliId generated by hbm2java
 */
@Embeddable
public class ArfafliId  implements java.io.Serializable {
    ...
    public ArfafliId(String noCia, String noFactu, int noLinea, String clave) {
       this.noCia = noCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArfafliId) ) return false;
		 ArfafliId castOther = ( ArfafliId ) other; 
