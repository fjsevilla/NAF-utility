...
/**
 * ArfafehId generated by hbm2java
 */
@Embeddable
public class ArfafehId  implements java.io.Serializable {
    ...
    public ArfafehId(String noCia, String noFactu) {
       this.noCia = noCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArfafehId) ) return false;
		 ArfafehId castOther = ( ArfafehId ) other; 
