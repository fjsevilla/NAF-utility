...
/**
 * ArinboId generated by hbm2java
 */
@Embeddable
public class ArinboId  implements java.io.Serializable {
    ...
    public ArinboId(String noCia, String codigo) {
       this.noCia = noCia;
       this.codigo = codigo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArinboId) ) return false;
		 ArinboId castOther = ( ArinboId ) other; 
