...
/**
 * ArinhaTa generated by hbm2java
 */
@Entity
@Table(name="ARINHA_TA"
    ,schema="DESA46"
)
public class ArinhaTa  implements java.io.Serializable {


     private ArinhaTaId id;
    ...
    public ArinhaTa(ArinhaTaId id) {
        this.id = id;
    }
    public ArinhaTa(ArinhaTaId id, BigDecimal ultCosto, BigDecimal saldoUn, BigDecimal saldoMo, BigDecimal costoUni, BigDecimal ajuIniReproceso, BigDecimal ultCostoRes, BigDecimal saldoMoRes, BigDecimal costoUniRes) {
       this.id = id;
    ...
    public ArinhaTaId getId() {
        return this.id;
    }
    
    public void setId(ArinhaTaId id) {
        this.id = id;
    }
