...
/**
 * ArccgrId generated by hbm2java
 */
@Embeddable
public class ArccgrId  implements java.io.Serializable {
    ...
    public ArccgrId(String noCia, String grupo) {
       this.noCia = noCia;
       this.grupo = grupo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArccgrId) ) return false;
		 ArccgrId castOther = ( ArccgrId ) other; 
